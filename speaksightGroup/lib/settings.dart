...
/// SettingsPage provides user-configurable options for the application.
///
/// This widget allows users to customize the app experience with settings for:
/// - Display preferences (dark mode, high contrast, text size)
/// - Accessibility options (voice feedback, speech rate)
/// - App information
///
/// Changes are persisted using SharedPreferences and immediately applied.
...
/// State for SettingsPage handling UI rendering and settings persistence.
///
/// This state manages:
/// - Loading and saving settings from/to SharedPreferences
/// - Toggle handlers for boolean settings
/// - Slider control for speech rate adjustment
...
class _SettingsPageState extends State<SettingsPage> with SingleTickerProviderStateMixin {
  ...
  /// 
  /// Retrieves previously saved user preferences and updates the UI state.
  /// Falls back to default values if settings haven't been saved before.
  _loadSettings() async {
  ...
  /// 
  /// Persists all user preferences and notifies the app about theme changes
  /// through the updateThemeMode callback.
  _saveSettings() async {
    final prefs = await SharedPreferences.getInstance();
  ...
  /// Creates a styled card for an individual setting.
  /// 
  /// Each setting card includes an icon, title, subtitle, and
  /// optional trailing widget (typically a switch or other control).
